...
#     def get(self, request):
#         user_profile = UserProfile()
#         user_profile.username = "931065540@qq.com"
#         user_profile.email = "931065540@qq.com"
#         user_profile.is_active = False
#         user_profile.password = make_password("3499jiajia")
#         user_profile.save()
#
#         # send_status = send_mail("说呢","你的我的", "13718770169m@sina.cn", ["921065540@qq.com"])
#         register_form = RegisterForm()
...
#                 if user.is_active:
#                     login(request, user)
#                     return HttpResponseRedirect("/110/")
#                 else:
